...
import com.motycka.edu.tracker.error.ErrorResponse
...
class ExceptionHandlerAdvice : ResponseEntityExceptionHandler() {
    ...
    fun forbiddenError(ex: RuntimeException, request: WebRequest): ResponseEntity<Any> {
    ...
    fun handleUnauthorized(ex: RuntimeException, request: WebRequest): ResponseEntity<Any> {
